...
const PRODUCTS = [
  // ---------------- AI & Developer Tools ----------------
  { id: "google-ai-pro", name: "Google AI Pro", category: "ai", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 75 }] },
  { id: "google-ai-ultra", name: "Google AI Ultra", category: "ai", topSeller: false,
    plans: [{ label: "1 Month", labelAr: "شهر واحد", price: 70 }] },
  { id: "claude-pro", name: "Claude Pro", category: "ai", topSeller: true, badge: "popular",
    plans: [{ label: "1 Month", labelAr: "شهر واحد", price: 18 }] },
  { id: "perplexity-pro", name: "Perplexity AI Pro", category: "ai", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 75 }] },
  ...
  { id: "warp-ai", name: "Warp AI", category: "ai", topSeller: false,
    plans: [{ label: "Build Plan — 12 Months", labelAr: "خطة البناء — 12 شهرًا", price: 120 }] },

  // ---------------- Design, Video & Productivity ----------------
  { id: "adobe-cc", name: "Adobe Creative Cloud", category: "design", topSeller: true,
    plans: [
  ...
  { id: "canva-pro", name: "Canva Pro", category: "design", topSeller: true, badge: "value",
  ...
  { id: "picsart-pro", name: "Picsart Pro", category: "design", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 45 }] },
  { id: "figma-pro", name: "Figma Pro", category: "design", topSeller: false,
    plans: [
  ...
  { id: "jira-premium", name: "Jira Software", category: "business", topSeller: false,
    plans: [{ label: "Premium Plan — 12 Months", labelAr: "خطة بريميوم — 12 شهرًا", price: 85 }] },
  { id: "linear-business", name: "Linear", category: "business", topSeller: false,
    plans: [{ label: "Business Plan — 12 Months", labelAr: "خطة الأعمال — 12 شهرًا", price: 90 }] },
  { id: "loom-business", name: "Loom", category: "business", topSeller: false,
  ...
  { id: "miro-ai", name: "Miro AI", category: "business", topSeller: false,
    plans: [{ label: "Starter Plan — 12 Months", labelAr: "خطة الانطلاق — 12 شهرًا", price: 45 }] },
  { id: "anydesk-solo", name: "AnyDesk Solo", category: "business", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 70 }] },
  { id: "linkedin-business-premium", name: "LinkedIn Business Premium", category: "business", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 117 }] },
  { id: "linkedin-career", name: "LinkedIn Career", category: "business", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 105 }] },

  // ---------------- Engineering & CAD ----------------
  { id: "autodesk-all-apps", name: "AutoDesk — All Apps", category: "engineering", topSeller: false,
    plans: [{ label: "3 Years", labelAr: "3 سنوات", price: 117 }] },
  { id: "autodesk-aec", name: "Autodesk AEC Commercial License", category: "engineering", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 450 }] },
  { id: "autodesk-bim-forma", name: "Autodesk BIM License / Forma", category: "engineering", topSeller: false,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 450 }] },
  ...
  { id: "sketchup-pro", name: "SketchUp", category: "engineering", topSeller: false,
  ...
  { id: "corona-premium", name: "Corona Premium", category: "engineering", topSeller: false,
    plans: [{ label: "Edu License — 12 Months", labelAr: "ترخيص تعليمي — 12 شهرًا", price: 150 }] },
  ...
  { id: "youtube-premium", name: "YouTube Premium", category: "learning", topSeller: true,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 45 }] },
  { id: "coursera-plus", name: "Coursera Plus", category: "learning", topSeller: false,
    plans: [{ label: "12 Months — Full Access", labelAr: "12 شهرًا — وصول كامل", price: 60 }] },
  { id: "duolingo-max", name: "Duolingo MAX", category: "learning", topSeller: true,
    plans: [{ label: "12 Months", labelAr: "12 شهرًا", price: 55 }] },
  { id: "duolingo-super", name: "Duolingo Super", category: "learning", topSeller: false,
